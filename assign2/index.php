        ...
        <div class="container">
            <div class="row banner">
                <div class="col">
                    ...
                    <p>I declare that this assignment is my individual work. I have not worked collaboratively nor have I copied from any other student's work or from any other source. I have made use of Bootstrap v4's grid system to assist with UI alignment. I make no claim to this code and it is used according to the <a href="https://getbootstrap.com/docs/4.0/about/license/">licensing terms</a>.</p>
                    <ul>
